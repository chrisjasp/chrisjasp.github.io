...
<main>
    ...
    <section class="right-slant-shape bg-primary pb-10 pt-4" data-cue="fadeIn">
       ...
       <div class="position-absolute z-1 w-100 text-center top-25 mt-n8" data-cue="zoomIn">
          <enhanced:img src='../../assets/images/me.png' alt="avatar" class="rounded-circle shadow-sm border border-white border-4" />
       </div>
    </section>
    <!--hero section end-->
                ...
                <div class="row">
                      ...
                      <div class="card bg-danger bg-opacity-10 border-0 mb-5" data-cue="fadeIn" data-delay="500">
                         <div class="card-body">
                            <div class="d-flex align-items-center">
                              <enhanced:img src="../../assets/images/personal-svg/html5.svg" alt="html" />
                   ...
                   <div class="col-md-6">
                     <div class="card bg-warning bg-opacity-10 border-0 mb-5 mb-lg-0" data-cue="fadeIn" data-delay="1000">
                        <div class="card-body">
                           <div class="d-flex align-items-center">
                              <enhanced:img src="../../assets/images/personal-svg/figma.svg" alt="html" />
                   ...
                   <div class="col-md-6">
                     <div class="card bg-primary-subtle bg-opacity-10 border-0 mb-5" data-cue="fadeIn" data-delay="2000">
                        <div class="card-body">
                           <div class="d-flex align-items-center">
                              <enhanced:img src="../../assets/images/personal-svg/dotnet.svg" width="40" height="40" alt="html" />
                   ...
                   <div class="col-md-6">
                     <div class="card bg-info bg-opacity-10 border-0 mb-5 mb-lg-0" data-cue="fadeIn" data-delay="1500">
                        <div class="card-body">
                           <div class="d-flex align-items-center">
                              <enhanced:img src="../../assets/images/personal-svg/svelte.svg" width="40" height="40" alt="html" />
                   ...
                   <div class="col-md-6">
                     <div class="card bg-success bg-opacity-10 border-0 mb-5" data-cue="fadeIn" data-delay="2000">
                        <div class="card-body">
                           <div class="d-flex align-items-center">
                              <enhanced:img src="../../assets/images/personal-svg/nodejs.svg" alt="html" />
                ...
                <div class="row">
                   <div class="col-md-6 col-12" data-cue="fadeIn">
                      <div class="mb-lg-8 mb-5 text-center text-lg-start px-3 px-lg-0">
                         <div class="mb-3">
                            <enhanced:img src="../../assets/images/process-icon/LightbulbFilament.svg" alt="bulb" />
                         </div>
                   ...
                   <div class="col-md-6 col-12" data-cue="fadeIn">
                      <div class="mb-lg-8 mb-5 text-center text-lg-start px-3 px-lg-0">
                         <div class="mb-3">
                            <enhanced:img src="../../assets/images/process-icon/PencilCircle.svg" alt="bulb" />
                         </div>
                   ...
                   <div class="col-md-6 col-12" data-cue="fadeIn">
                      <div class="mb-lg-8 mb-5 text-center text-lg-start px-3 px-lg-0">
                         <div class="mb-3">
                            <enhanced:img src="../../assets/images/process-icon/BracketsCurly.svg" alt="bulb" />
                         </div>
                   ...
                   <div class="col-md-6 col-12" data-cue="fadeIn">
                      <div class="mb-lg-8 mb-5 text-center text-lg-start px-3 px-lg-0">
                         <div class="mb-3">
                            <enhanced:img src="../../assets/images/process-icon/Rocket.svg" alt="bulb" />
                         </div>
                ...
                <div class="row g-lg-10 gy-5 align-items-center">
                   ...
                   <div class="col-md-6" data-cue="zoomIn">
                      <div class="mb-7 text-center text-lg-start">
                         <div class="mb-3">
                            <enhanced:img src="../../assets/images/me.png" alt="avatar" class="avatar avatar-xl rounded-circle" />
                         </div>

                         <h3 class="mb-0">Chris Jasper</h3>
                         <small>Senior Engineer at NetFile</small>
                      </div>
                      ...
                      <div class="d-flex mb-4">
                         ...
                         <div class="ms-2">
                            ...
                            <small>
                               <a href="#!" class="text-reset">iam@chrisjasper.dev</a>
                            </small>
                         </div>
                      </div>
                      <!-- <div>
